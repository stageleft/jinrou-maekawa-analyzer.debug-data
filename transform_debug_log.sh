...
for i in $( seq 1 20 ) ; do
    create_html org/$1/${i}d.txt sample/$1/day${i}.html
    create_html org/$1/${i}n.txt sample/$1/day${i}-night.html
done
create_html org/$1/ep.txt sample/$1/dayX-aftergame.html
mv sample/$1/day1.html sample/$1/day1-beforegame